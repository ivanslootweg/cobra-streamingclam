...
DATASET_SIZE = None
DATA_OUT = Path(r"C:\Documents\Werkzaken\Radboudumc\Pathologie\cobra-streamingclam")
...
def create_symlinks(label_csv,split="train"):
    ...
    print(image_source_path, DATA_OUT / f"images/{slide}.tif")
...
if __name__ == "__main__":
    ...
    data_source_folder = Path(r"\\blissey.umcn.nl\pathology\archives\skin\cobra\data\biopsies")
    label_folder = Path(r"\\blissey.umcn.nl\pathology\archives\skin\cobra\folds\bcc_risk")
